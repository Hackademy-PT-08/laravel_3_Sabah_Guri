    ...
    public function showCategory($category){
        ...
        foreach($this->recipes as $recipe){
            if($category==$recipe['category']){
                $filteredByCategory[]=$recipe;
                
            }
        }
        return view('categoria-piatto',['recipes'=>$filteredByCategory]);
    }
    ...
    public function showRegion($region){
        ...
        foreach($this->recipes as $recipe){
            if($region==$recipe['region']){
                $filteredByRegion[]=$recipe;
            }
        }
        return view('categoria-regione',['recipes'=>$filteredByRegion]);
    }
